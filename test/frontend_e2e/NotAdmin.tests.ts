...
describe('Login Tests', () => {
    ...
    const admin_username = process.env.TEST_USERNAME_ADMIN || 'testuser';
    const admin_password = process.env.TEST_PASSWORD || 'testpassword';
    ...
    test('Login with valid non-admin credentials', async () => {
        ...
        // Logout
        await driver.get('http://localhost:3007/login');
